<template>
  <div class="chatbot-floating" :class="{ open: isOpen, mobile: isMobile }">
    <Transition name="panel">
      <div v-if="isOpen" class="chat-panel" role="dialog" aria-label="LocalHub 챗봇">
        <header class="chat-header">
          ...
          <div class="chat-header-actions">
            ...
            <button type="button" class="icon-btn" title="닫기" @click="toggleOpen">✕</button>
          </div>
        </header>
